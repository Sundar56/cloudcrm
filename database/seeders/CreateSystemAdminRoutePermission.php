...
class CreateSystemAdminRoutePermission extends Seeder
{
    /**
    ...
    {
        $modules = Module::where('module_type', 1)->where('status', 1)->pluck('slug', 'id');
